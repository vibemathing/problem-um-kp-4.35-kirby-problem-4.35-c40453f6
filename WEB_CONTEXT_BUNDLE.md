...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.35-kirby-problem-4.35-c40453f6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.35"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.35-kirby-problem-4.35-c40453f6-v1",
      "problem_contract_sha256": "6d2b89bede6104d24863ed5762b03e102a446a2dabdb2c9d6d3e5bd5ef93ddf2",
      "problem_id": "problem:um-kp-4.35-kirby-problem-4.35-c40453f6",
      "route_id": "route:um-kp-4.35-kirby-problem-4.35-c40453f6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.35-kirby-problem-4.35-c40453f6-source-fidelity-01",
      "graph_id": "graph:um-kp-4.35-kirby-problem-4.35-c40453f6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.35-kirby-problem-4.35-c40453f6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.35-kirby-problem-4.35-c40453f6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Give an algebraic classification of groups that arise as the fundamental group of the complement of a smooth or locally flat 2-sphere in $S^{4}$. (b) Let $\\Lambda = \\mathbb{Z}[t, t-^{1}]$. Classify the $\\Lambda-modules$ that arise as the Alexander module of a smooth or locally flat 2-sphere in $S^{4}$."
          },
          "statement_sha256": "811dc58794ca3e175523966e38149c0a6aaec84ae15f8636f48c1aca4f15ecea"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.35-kirby-problem-4.35-c40453f6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.35-kirby-problem-4.35-c40453f6-root",
      "route_id": "route:um-kp-4.35-kirby-problem-4.35-c40453f6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.35-502c64811bec",
        "url": "https://www.unsolvedmath.com/problems/KP-4.35"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
